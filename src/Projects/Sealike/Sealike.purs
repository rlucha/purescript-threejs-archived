...
-- import Three (createGeometry, forceVerticesUpdate, pushVertices, updateVector3Position, getVector3Position)
...
-- getProjectObjects :: Project -> Object3D
...
--   in traverse_ (updateVector t) vs *> forceVerticesUpdate g
