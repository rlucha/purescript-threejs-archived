...
var getVector3Position = function(vs) {
  return function() {
    return {
      x:vs.x,
      y:vs.y,
...
var updateVector3Position = function(x) {
  return function(y) {
    return function(z) {
      return function(v3) {
        return function() {
...
var onDOMContentLoaded = function(cb) {
  return function() {
...
module.exports = {
  ...
  getVector3Position: getVector3Position,
...
// const create = function(ps_scene) { 
//   return function() {
